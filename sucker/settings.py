...
ALLOWED_HOSTS = ['localhost','178.128.122.169','sucker.rikhsan.com']
...
ROOT_URLCONF = 'sucker.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'sucker/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sucker.wsgi.application'
